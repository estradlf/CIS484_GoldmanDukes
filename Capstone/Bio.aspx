<%@ Page Title="" Language="C#" MasterPageFile="~/MainTemplate.Master" AutoEventWireup="true" CodeBehind="Bio.aspx.cs" Inherits="Lab3.WebForm4" %>
    ...
    <div class="container border border-1 bg-light">
        ...
        <div class="row">
            <div class="col-md-6 text-center">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="First Name cannot be blank" ForeColor="Red" SetFocusOnError="true" ControlToValidate="txtFirstName"></asp:RequiredFieldValidator>
            </div>
            <div class="col-md-6 text-center">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Last Name Cannot be blank" ForeColor="Red" SetFocusOnError="true" ControlToValidate="txtLastName"></asp:RequiredFieldValidator>
            </div>
        </div>
        <br />
        <%-- Button Section --%>
